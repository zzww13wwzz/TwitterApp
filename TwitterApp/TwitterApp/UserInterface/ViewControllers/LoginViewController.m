...
- (STTwitterOAuth *)oauth {
    if (!_oauth) {
        _oauth = [STTwitterOAuth twitterOAuthWithConsumerName:@"TwitterApp" consumerKey:@"vlmu1T2Vpsh1vN9jzCxSntnRo" consumerSecret:@"By0VWWIipsJxATQ43vTJUGTBXDYZcYrcbFnDH1yD9vW8cuuKmE"];
    }
    return _oauth;
}
